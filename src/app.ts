...
function validateable(validatableInput: Validateable) {
  let isValid = true;
...
class ProjectInput {
  ...
  private gatherUserInput(): [string, string, number] | void {
    ...
    const titleVaildatable: Validateable = {
      value: enteredTitle,
      required: true,
    };
    ...
    if (
      !validateable(titleVaildatable) ||
      !validateable(descriptionValidatable) ||
      !validateable(peopleValidatable)
    ) {
